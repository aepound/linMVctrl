function drawSpacecraft(uu,pts)
    ...
    if t<=0.1,
        ...
        hold on
        traj_handle= plot3(ppn,ppe,ppd,'EraseMode', 'normal');
        hold on;
        ...
        ylabel('North')
        zlabel('-Down')
        view(-36,27)  % set the vieew angle for figure
        
        axis(6*150*[-10,10,-10,10,-10,10]);
    ...
    % at every other time step, redraw base and rod
        ...
        set(traj_handle,'XData',ppn,'YData',ppe,'ZData',ppd);
    drawnow
    end
end
